...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, LSC_1,   LSC_2,   LSC_3,   LSC_4,   LSC_5,   _______, _______, _______, _______, _______, _______, _______, QK_BOOT,          _______,
        _______, RGB_TOG, LSC_U,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_HOME,
        _______, LSC_L,   LSC_D,   LSC_R,   _______, _______, _______, _______, _______, _______, _______, _______,          _______,          KC_END,
