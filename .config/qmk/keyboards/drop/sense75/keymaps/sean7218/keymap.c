...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             _______, MO(1),   TG(1),   KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT(
        ...
        _______, _______, A(KC_K), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_HOME,
        _______, A(KC_H), A(KC_J), A(KC_L), _______, _______, _______, _______, _______, _______, _______, _______,          RGB_TOG,          KC_END,
