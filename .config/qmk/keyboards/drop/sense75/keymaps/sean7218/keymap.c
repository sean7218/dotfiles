...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             _______, MO(1),   KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT(
        ...
        _______, _______, A(KC_W), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_HOME,
        _______, A(KC_A), A(KC_S), A(KC_D),    _______, _______, _______, _______, _______, _______, _______, _______,          RGB_TOG,          KC_END,
