...
#define RCTLJ RALT_T(KC_J)
#define RSFTK RSFT_T(KC_K)
#define RALTL RALT_T(KC_L)
#define RGUIN RGUI_T(KC_SCLN)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             TG(1),   MO(1),   KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT(
        ...
        _______, _______, KC_W,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_HOME,
        _______, KC_A,    KC_S,    KC_D,    _______, _______, _______, _______, _______, _______, _______, _______,          RGB_TOG,          KC_END,
        KC_LSFT,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
        _______, _______, KC_LALT,                            QK_LEAD,                             KC_APP,  _______, _______, _______, _______, _______
    )
};
